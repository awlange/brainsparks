...
def main():
    ...
    net = ParticleVectorNNetwork(cost="mse", particle_input=ParticleVectorNInput(2))
    net.append(ParticleVectorN(2, 3, activation="sigmoid"))
    net.append(ParticleVectorN(3, 2, activation="sigmoid"))
...
def fd():
    ...
    net = ParticleVectorNNetwork(cost="categorical_cross_entropy", particle_input=ParticleVectorNInput(2))
    net.append(ParticleVectorN(2, 5, activation="tanh"))
    net.append(ParticleVectorN(5, 4, activation="tanh"))
    net.append(ParticleVectorN(4, 3, activation="softmax"))
