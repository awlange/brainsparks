...
def main():
    ...
    net = ParticleVectorNLocalConvolution2Network(cost="mse", particle_input=ParticleVectorNLocalConvolution2Input(2))
    net.append(ParticleVectorNLocalConvolution2(2, 3, activation="sigmoid", apply_convolution=True, delta_r=0.1))
    net.append(ParticleVectorNLocalConvolution2(3, 2, activation="sigmoid"))
